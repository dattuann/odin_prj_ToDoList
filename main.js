...
/* harmony export */   "default": () => (/* binding */ createTDElement)
/* harmony export */ });
...
function createTDElement(content, date, finish, priority) {
  ...
  var priorityDiv = document.createElement('button');
  ...
  function coloringContainer() {
    var chillColor = "#748ffc";
    var urgentColor = "#ffa94d";
    var relaxColor = "#a9e34b";
    var chillColorBtn = "#a5d8ff";
    var urgentColorBtn = "#ffd8a8";
    var relaxColorBtn = "#d8f5a2";
  ...
  function lineThroughContainer() {
    ___WEBPACK_IMPORTED_MODULE_0__.toDoList.findIndexInList(contentDiv.textContent, dateDiv.textContent, function (index) {
      if (___WEBPACK_IMPORTED_MODULE_0__.toDoList.listArray[index].finish) {
  ...
  contentDiv.addEventListener('click', function () {
    ___WEBPACK_IMPORTED_MODULE_0__.toDoList.toggleFinishStatus(contentDiv.textContent, dateDiv.textContent);
    lineThroughContainer();
    (0,___WEBPACK_IMPORTED_MODULE_0__.saveToLocal)();
  });
  priorityDiv.addEventListener('click', function () {
    ___WEBPACK_IMPORTED_MODULE_0__.toDoList.togglePriorityStatus(contentDiv.textContent, dateDiv.textContent);
    ___WEBPACK_IMPORTED_MODULE_0__.toDoList.findIndexInList(contentDiv.textContent, dateDiv.textContent, function (index) {
      priorityDiv.textContent = ___WEBPACK_IMPORTED_MODULE_0__.toDoList.listArray[index].priority.toUpperCase();
      coloringContainer();
    });
    (0,___WEBPACK_IMPORTED_MODULE_0__.saveToLocal)();
  });
  ...
  dropDownBtn.addEventListener('click', function (event) {
    ...
    var allDropDownDivs = document.querySelectorAll('.drop_down_div');
    allDropDownDivs.forEach(function (div) {
      if (div !== dropDownDiv) {
  ...
  removeBtn.addEventListener('click', function () {
    ___WEBPACK_IMPORTED_MODULE_0__.toDoList.removeFromList(content, date);
    toDoContainer.remove();
    (0,___WEBPACK_IMPORTED_MODULE_0__.saveToLocal)();
  });
  editBtn.addEventListener("click", function () {
    var content = contentDiv.textContent;
    var date = dateDiv.textContent;
    var contentDivEditing = document.createElement('span');
    ...
    var dateDivEditing = document.createElement('input');
    dateDivEditing.classList.add("date_div");
    dateDivEditing.id = "date_div_editing";
    dateDivEditing.setAttribute("type", "date");
    var parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(dateDiv.textContent, "dd-MM-yyyy", new Date());
    dateDivEditing.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(parsedDate, "yyyy-MM-dd");
    contentDiv.remove();
    dateDiv.remove();
    ...
    if (contentDivEditing) {
      document.addEventListener('keydown', function (event) {
        if (event.key === "Enter") {
          ...
          ___WEBPACK_IMPORTED_MODULE_0__.toDoList.modifyToDo(content, date, contentDivEditing.textContent, dateDivEditing.value);
          contentDiv.textContent = contentDivEditing.textContent;
          var newDate = dateDivEditing.value;
          dateDiv.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(newDate), "dd-MM-yyyy");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   dialogInterface: () => (/* binding */ dialogInterface),
/* harmony export */   saveToLocal: () => (/* binding */ saveToLocal),
/* harmony export */   toDoList: () => (/* binding */ toDoList)
/* harmony export */ });
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ "./src/style.css");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/format.mjs");
/* harmony import */ var _createTDElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createTDElement */ "./src/createTDElement.js");
...
var toDoList = function () {
  ...
  function findIndexInList(content, date, callback) {
    var index = listArray.findIndex(function (array) {
      return array.content === content && array.date === date;
    });
    if (index != -1) {
      callback(index);
    }
  ...
  function removeFromList(content, date) {
    findIndexInList(content, date, function (index) {
  ...
  function modifyToDo(content, date, newContent, newDate) {
    findIndexInList(content, date, function (index) {
      ...
      listArray[index].date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(newDate), "dd-MM-yyyy");
    });
  }
  return {
    listArray: listArray,
    ...
    toggleFinishStatus: toggleFinishStatus,
    findIndexInList: findIndexInList,
    togglePriorityStatus: togglePriorityStatus,
    modifyToDo: modifyToDo
  };
}();
function saveToLocal() {
  var listArray = toDoList.listArray;
  var listArrayJson = JSON.stringify(listArray);
  localStorage.setItem('UniqueToDoListKey', listArrayJson);
}
function loadFromLocal() {
  var savedListJSON = localStorage.getItem('UniqueToDoListKey');
  if (savedListJSON) {
    var savedListArray = JSON.parse(savedListJSON);
    savedListArray.forEach(function (element) {
      toDoList.addToList(element.content, element.date, element.finish, element.priority);
    });
  }
}
function populateContainer() {
  toDoList.listArray.forEach(function (element) {
    (0,_createTDElement__WEBPACK_IMPORTED_MODULE_1__["default"])(element.content, element.date, element.finish, element.priority);
  });
}
var dialogInterface = function () {
  var dialogBtn = document.getElementById('dialog_btn');
  var submitBtn = document.getElementById('submit_btn');
  var contentInput = document.getElementById("content_input");
  var contentInputBody = document.getElementById("content_input_body");
  var dateInput = document.getElementById("date_input");
  var priorityInput = document.getElementById("priority_input");
  var todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)("".concat(new Date().getFullYear(), "-").concat(new Date().getMonth() + 1, "-").concat(new Date().getDate()), "yyyy-MM-dd");
  ...
  var submitForm = function submitForm() {
    if (contentInput.value) {
      var inputValues = [contentInput.value, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(dateInput.value), 'dd-MM-yyyy'), false, priorityInput.value];
      _createTDElement__WEBPACK_IMPORTED_MODULE_1__["default"].apply(void 0, inputValues);
      toDoList.addToList.apply(toDoList, inputValues);
      contentInput.value = "";
  ...
  contentInputBody.addEventListener("input", function () {
...
::backdrop {
  ...
  opacity: 0.75;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,gBAAgB;EAChB,0BAA0B;EAC1B,oCAAoC;EACpC,8BAA8B;EAC9B,kBAAkB;EAClB,sBAAsB;EACtB,qBAAqB;EACrB,qBAAqB;AACvB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,wBAAwB;EACxB,gBAAgB;EAChB,eAAe;EACf,YAAY;AACd;;AAEA;EACE,WAAW;EACX,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,uBAAuB;EACvB,mBAAmB;EACnB;IACE,aAAa;IACb,mBAAmB;IACnB,mBAAmB;IACnB,YAAY;IACZ,cAAc;IACd,qBAAqB;IACrB,kBAAkB;EACpB;EACA;IACE,kBAAkB;IAClB,sBAAsB;;EAExB;EACA;IACE,uBAAuB;IACvB,mBAAmB;IACnB,YAAY;EACd;AACF;;AAEA;EACE;wEACsE;EACtE,6BAA6B;EAC7B,mBAAmB;EACnB,aAAa;EACb,sBAAsB;EACtB,aAAa;EACb,gBAAgB;EAChB,kBAAkB;EAClB,iBAAiB;EACjB,QAAQ;AACV;;AAEA;EACE,UAAU;EACV,uHAAuH,GAAG,WAAW;EACrI,mBAAmB;EACnB,aAAa;EACb,SAAS;EACT;;iBAEe;EACf,8BAA8B;EAC9B;IACE,kBAAkB;EACpB;;EAEA;IACE,eAAe;IACf,kBAAkB;IAClB,eAAe;EACjB;;EAEA;IACE,sBAAsB;IACtB,YAAY;IACZ,kBAAkB;IAClB,YAAY;IACZ,mBAAmB;IACnB,gBAAgB;IAChB,kBAAkB;EACpB;;EAEA;IACE,sBAAsB;IACtB,YAAY;EACd;;EAEA;IACE,0BAA0B;EAC5B;;EAEA;IACE,aAAa;IACb,sBAAsB;IACtB,iBAAiB;IACjB,gBAAgB;IAChB,mBAAmB;IACnB,cAAc;EAChB;;EAEA;IACE,YAAY;IACZ,yBAAyB;IACzB,yBAAyB;IACzB,eAAe;IACf,eAAe;EACjB;;EAEA;IACE,aAAa;IACb,kBAAkB;IAClB,sBAAsB;IACtB,uBAAuB;IACvB,UAAU;EACZ;;EAEA;IACE,eAAe;EACjB;;EAEA;IACE,mBAAmB;IACnB,mBAAmB;IACnB,cAAc;IACd,eAAe;IACf,kBAAkB;IAClB,eAAe;IACf,UAAU;EACZ;;EAEA;EACA;AACF;;AAEA;EACE,uBAAuB;EACvB;IACE,aAAa;IACb,sBAAsB;IACtB,WAAW;IACX;MACE,uBAAuB;MACvB,YAAY;IACd;EACF;AACF;;AAEA;EACE,wDAAwD;EACxD,aAAa;AACf","sourcesContent":[":root {\n  --black: #000000;\n  --anta: \"Anta\", sans-serif;\n  --fellFrench: \"IM Fell French Canon\";\n  --petit: \"Petit Formal Script\";\n  --blueBtn: #dbe4ff; \n  --urgentColor: #ffa94d;\n  --chillColor: #748ffc;\n  --relaxColor: #a9e34b;\n}\n\nbody {\n  height: 100vh;\n  background-color: var(--black);\n  color: white;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  align-items: center;\n  overflow-y: hidden;\n}\n\nheader {\n  font-family: var(--anta);\n  font-weight: 400;\n  font-size: 64px;\n  height: 70px;\n}\n\n.insert_div, .container {\n  width: 50vw;\n  min-width: 400px; \n}\n\n.insert_div {\n  display: grid;\n  grid-template-columns: 4fr 1fr;\n  justify-content: center;\n  align-items: center;\n  input, button {\n    display: flex;\n    align-items: center;\n    border-radius: 32px;\n    height: 40px;\n    font-size: 3em;\n    place-content: center;\n    overflow-y: hidden;\n  }\n  input {\n    padding-left: 20px;\n    font-family: monospace;\n\n  }\n  button {\n    background-color: black;\n    border-color: white;\n    color: white;\n  }\n}\n\n.container {\n  background: linear-gradient(black, black) padding-box,\n              linear-gradient(to right, darkblue, darkorchid) border-box;\n  border: 4px solid transparent;\n  border-radius: 32px;\n  display: flex;\n  flex-direction: column;\n  height: 500px;\n  overflow-y: auto;\n  overflow-x: hidden;\n  user-select: none;\n  gap: 5px;\n}\n\n.to_do_container {\n  z-index: 0;\n  box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;  width: 100%;  \n  height: fit-content;\n  display: grid;\n  gap: 10px;\n  grid-template-areas:\n  \"content button\"\n  \"date priority\";\n  grid-template-columns: 3fr 1fr;\n  .content_div, .date_div {\n    padding-left: 30px;\n  }\n\n  .content_div {\n    font-size: 32px;\n    grid-area: content;\n    cursor: pointer;\n  }\n\n  #content_div_editing {\n    background-color: grey;\n    cursor: auto;\n    font-family: serif;\n    color: white;\n    height: max-content;\n    min-height: 70px;\n    overflow-y: scroll;\n  }\n\n  #date_div_editing {\n    background-color: grey;\n    color: white;\n  }\n\n  .content_div::first-letter {\n    text-transform: capitalize;\n  }\n\n  .drop_down {\n    display: flex;\n    flex-direction: column;\n    grid-area: button;\n    align-items: end;\n    justify-self: right;\n    margin: 0 30px;\n  }\n  \n  .drop_down_btn, .remove_btn, .edit_btn {\n    color: white;\n    border: 0.5px solid white;\n    background-color: #000000;\n    cursor: pointer;\n    font-size: 16px;\n  }\n\n  .drop_down_div {\n    display: none;\n    position: relative;\n    flex-direction: column;\n    background-color: black;\n    z-index: 1;\n  }\n\n  .date_div {\n    grid-area: date;\n  }\n\n  .priority_div {\n    grid-area: priority;\n    justify-self: right;\n    margin: 0 30px;\n    font-size: 16px;\n    width: fit-content;\n    cursor: pointer;\n    z-index: 0;\n  }\n\n  .drop_down_btn, .priority_div {\n  }\n}\n\ndialog {\n  background-color: black;\n  form {\n    display: flex;\n    flex-direction: column;\n    width: 60vw;\n    button, #content_input, select {\n      background-color: black;\n      color: white;\n    }\n  }\n}\n\n::backdrop {\n  background-image: linear-gradient( darkblue, darkorchid); \n  opacity: 0.75;\n}"],"sourceRoot":""}]);
// Exports
